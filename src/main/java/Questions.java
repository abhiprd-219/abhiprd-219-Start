...
public class Questions {
    int question1(){
        /* 
         * Replace the  0   again in the return statement  with the answer you believe to be true for the question below
         * 
         * How many    variables  vf are in the  class "Vehicle"? 
         */
        return 3;
    }
